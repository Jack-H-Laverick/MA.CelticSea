...
new <- read.csv("./StrathE2E/Celtic_Sea_NM/2003-2013/Driving/chemistry_CELTIC_SEA_2003-2013.csv") %>%   # Read in example boundary drivers
...
new <- read.csv("./StrathE2E/Celtic_Sea_NM/2003-2013/Driving/physics_CELTIC_SEA_2003-2013.csv") %>%   # Read in example boundary drivers
